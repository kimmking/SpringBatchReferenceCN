...
* [4. 配置并运行Job](04_config_job/README.md)
   * [4.1 Configuring a Job](04_config_job/41.md)
   * [4.2 Java Config](04_config_job/42.md)
   * [4.3 Configuring a JobRepository](04_config_job/43.md)
   * [4.4 Configuring a JobLauncher](04_config_job/44.md)
   * [4.5 Running a Job](04_config_job/45.md)
   * [4.6 Meta-Data 高级用法](04_config_job/46.md)
* [5. 配置Step](05_config_step/README.md)
* [6. ItemReaders和ItemWriters](06_ItemReaders_ItemWriters/README.md)
...
* [7. 扩展与并行处理](07_scaling_parallel/README.md)
   * [7.1 多线程 Step](07_scaling_parallel/71.md)
   * [7.2 并行 Steps](07_scaling_parallel/72.md)
   * [7.3 远程分块](07_scaling_parallel/73.md)
   * [7.4 分区](07_scaling_parallel/74.md)
